...
(function () {
	...
	this.run = function () {
		...
		this.ctx.drawImage(this.pointerImg, this.pointer.x - 100, this.pointer.y - 100, 200, 200);
	...
	this.particleImg.src = 'https://res.cloudinary.com/dadp1865s/image/upload/v1732263863/person_in_heart_2_wnhyxk.png'; // Replace with your particle image URL
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const translations = {
        ...
        "somethings1": "Algunas cosas",
        "meanttobe1": "Están destinadas a ser",
        "takemyhand1": "Toma mi mano",
        ...
        "somethings2": "Algunas cosas",
        "meanttobe2": "Están destinadas a ser",
        "takemyhand2": "Toma mi mano",
    ...
    document.querySelectorAll("h2").forEach((element) => {
        const id = element.id; // Obtener el id del <h2>
        if (translations[id]) {
            element.textContent += ` (${translations[id]})`; // Añadir traducción
        }
    });
});
